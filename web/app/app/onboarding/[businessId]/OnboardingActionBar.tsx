...
export function OnboardingActionBar({
  ...
  return (
    <div className="sticky bottom-0 z-10 -mx-4 mt-10 border-t border-(--color-border) bg-white/95 px-4 py-4 backdrop-blur-sm sm:-mx-6 sm:px-6 lg:-mx-10 lg:px-10"
      style={{ paddingBottom: 'calc(env(safe-area-inset-bottom, 0px) + 1rem)' }}
    >
      <div className="mx-auto flex max-w-[1800px] flex-col-reverse items-stretch gap-3 sm:flex-row sm:items-center sm:justify-between">
